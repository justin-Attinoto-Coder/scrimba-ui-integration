            ...
            <div class="mb-8">
                <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    <div class="lg:w-1/2 space-y-6 text-gray-800 dark:text-gray-200">
                        <div class="bg-linear-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 p-6 rounded-2xl border border-green-100 dark:border-green-800 text-gray-800 dark:text-gray-800">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                <div class="flex items-center text-gray-800 dark:text-gray-300">
                                    ...
                                    <span class="text-gray-800 dark:text-gray-300">${cabin.capacity}</span>
                                </div>
                                <div class="flex items-center text-gray-800 dark:text-gray-300">
                                    <svg class="w-5 h-5 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                    </svg>
                                    <span class="text-gray-800 dark:text-gray-300">${cabin.size}</span>
                                </div>
                                <div class="flex items-center text-gray-800 dark:text-gray-300">
                                    <svg class="w-5 h-5 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span class="text-gray-800 dark:text-gray-300">${cabin.location}</span>
                                </div>
                                <div class="flex items-center text-gray-800 dark:text-gray-300">
                                    <svg class="w-5 h-5 text-green-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-gray-800 dark:text-gray-300">Verified</span>
                                </div>
                            </div>
                        </div>
                        
                        <p class="text-gray-800 dark:text-gray-200 leading-relaxed text-lg">${cabin.description}</p>
                        
                        <!-- Action Buttons -->
                        <div class="flex flex-col sm:flex-row gap-4 text-gray-800 dark:text-gray-200">
